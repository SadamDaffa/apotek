...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check_user) > 0) {
        ...
        $stmt->bind_param("ssss", $user, $nama, $password, $level);
...
<body>
    <form action="" method="post">
        <div class="col-md-3 kotak">
            ...
            <?php if (isset($error)): ?>
                <p style="color: red; font-style: italic;"><?php echo $message; ?></p>
            <?php endif; ?>
            ...
            <br>
            <center>
                <p>Already have an account? <a href="login.php" title="login" target="_blank">Login</a></p>
