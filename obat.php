        ...
        <div class="sidebar" data-color="green" data-image="assets/img/sidebar-5.jpg">
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    ?>
                    <!-- <li>
                    <a href="penjualan_obat_sehat.php">
                        <i class="pe-7s-note2"></i>
                        <p>Penjualan Obat Sehat</p>
                    </a>
                </li> -->
                    <?php //} 
                    ?>
                            ...
                            <li>
                                <form action="" method="post">
                                    <div class="form-group">
                                        <input type="text" size="30" name="keyword" autocomplete="off" autofocus
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <h5><b>
                                    <?php echo "Jumlah Data Obat: " . $jumlah['jumlah']; ?>
                                </b></h5>
                            <p style="color: red;font-size: 10px;">* Warna merah pada expired, menandakan obat sudah
                                expired!</p>
                            <div class="card">
                                <div class="header">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_obat as $data): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($_SESSION['level'] == 'pegawai' || $_SESSION['level'] == 'admin') { ?>
                                                            <a href="update_obat.php?id=<?= $data['id'] ?>"
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                        ...
                        </script> <a href="#">Apotek kalangsari</a>, Jl. Proklamasi, Kec. Rengas Dengklok, Desa Kalang Sari.
                    </p>
                </div>
            </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" class="mx-2">
                        <div class="form-group">
                            <label>Nama</label>
                            <input name="nama" type="text" class="form-control" placeholder="Nama Obat .."
                                autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>Harga</label>
                            <input name="harga" type="text" class="form-control" placeholder="Harga Obat .."
                                autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>Stok</label>
                            <input name="stok" type="text" class="form-control" placeholder="Stok Obat .."
                                autocomplete="off" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div
                                style="display: flex; align-items: center; flex-wrap: wrap; justify-content: flex-start; gap: 10px;">
                                <?php foreach ($tipe_obat as $tipe) { ?>
                                    <?php foreach ($tipe as $k => $v) { ?>
                                        <div class="form-check" style="margin-right: 10px;">
                                            <input class="form-check-input" type="checkbox" name="khasiat[]" value="<?= $v ?>"
                                                id="flexCheckDefault">
