...
<body>
    ...
    -->
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'pegawai' || $_SESSION['level'] == 'user') { ?>
                        <li class="active">
                            <a href="index.php">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                        ...
                        </script> <a href="#">Apotek kalangsari</a>, Jl. Proklamasi, Kec. Rengas Dengklok, Desa kalangsari.
                    </p>
                </div>
            </footer>
