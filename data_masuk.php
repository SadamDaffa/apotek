            ...
            <?php if($_SESSION['level'] == 'pegawai') { ?>
                <li>
                    <a href="penjualan_obat_sehat.php">
                        <i class="pe-7s-note2"></i>
                        <p>Penjualan Obat Sehat</p> <?php /// buat button laporan Apotek ?>
                    </a>
                </li>
            <?php } ?>
            </ul>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">Apotek kalangsari</a>, Jl. Proklamasi, Kec. Rengas Dengklok, Desa Kalang Sari.
                </p>
            </div>
        </footer>
